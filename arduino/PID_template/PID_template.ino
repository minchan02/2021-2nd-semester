...
#define _DIST_MAX 420 // [2972] 거리 센서가 인식 가능하게 설정한 최대 거리

// Distance sensor
#define _DIST_ALPHA 0.4   // [2959] ema 필터에 적용할 알파값

// Servo range
#define _DUTY_MIN 1410 // [2952] 서보의 최소 각도값 왼쪽으로 올라감 
#define _DUTY_NEU 1785 // [2952] 서보의 중간 각도값 (1750- 1820)
#define _DUTY_MAX 2180 // [1691] 서보의 최대 각도
...
// Event periods
#define _INTERVAL_DIST 15  //[2959] 센서의 거리측정 인터벌값
#define _INTERVAL_SERVO 15 //[2967] 서보 INTERVAL값 설정
#define _INTERVAL_SERIAL 100  //[2959] 시리얼 모니터/플로터의 인터벌값 설정

// PID parameters
#define _KP 0.45 // [2957] 비례 제어 값
                // [2961] 비례이득
...
////////////////////
  ...
  // PID control logic
    ...
    pterm = error_curr;                   // [2959] PID의 P 
    control = _KP * pterm;                // [2959] 중간에서 얼마나 움직일 것인가(지금은
                                          //        P만 적용됨, 이후 I, D 추가)
